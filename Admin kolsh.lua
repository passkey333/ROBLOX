local owners = {"hl_kill"} -- Are able to set admins who can ban/etc... using :pa name
local admins = {"hl_kill"} -- Sets admins who can use ban/kick/admin or shutdown
local tempadmins = {} -- Sets admins who can't use ban/kick/admin or shutdown
local banland = {"hl_kill"} -- Permanently Bans people
